...
class AnalyticsService {
  ...
  static Future<void> logCVDownload(String type) async {
    await _analytics.logEvent(name: 'cv_download', parameters: {'type': type});
  }
  ...
  static Future<void> logCertificateView(int certificateIndex) async {
    await _analytics.logEvent(
      ...
      parameters: {'certificate_index': certificateIndex},
    );
  }

  /// Log contact action
  static Future<void> logContactAction() async {
    await _analytics.logEvent(name: 'contact_action');
  }
